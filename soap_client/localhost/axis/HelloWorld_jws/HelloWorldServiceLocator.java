...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements localhost.axis.HelloWorld_jws.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/axis/HelloWorld.jws";
    ...
    public localhost.axis.HelloWorld_jws.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            localhost.axis.HelloWorld_jws.HelloWorldSoapBindingStub _stub = new localhost.axis.HelloWorld_jws.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (localhost.axis.HelloWorld_jws.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                localhost.axis.HelloWorld_jws.HelloWorldSoapBindingStub _stub = new localhost.axis.HelloWorld_jws.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8080/axis/HelloWorld.jws", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8080/axis/HelloWorld.jws", "HelloWorld"));
        }
